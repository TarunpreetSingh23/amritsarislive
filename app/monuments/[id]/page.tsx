...
export default function MonumentDetailPage({
  ...
  const infoItems = useMemo(() => {
    if (!monument) return [];
    return [
      { icon: <Clock size={18} />, label: 'Timings', value: monument.timings },
      { icon: <Ticket size={18} />, label: 'Entry Fee', value: monument.entryFee },
      { icon: <Timer size={18} />, label: 'Time Required', value: monument.timeRequired },
      { icon: <Sun size={18} />, label: 'Best Time to Visit', value: monument.bestTime },
    ].filter((i) => i.value);
  }, [monument]);
  ...
  if (loading) {
    return (
      <div className="mon-loader-container">
        ...
        <p className="mon-loader-text">Loading Monument</p>
      </div>
    );
  }
  ...
  if (!monument) {
    return (
      <div className="mon-notfound-container">
        ...
        <h1 className="mon-notfound-title">Monument Not Found</h1>
        <p className="mon-notfound-text">This monument doesn&apos;t exist or has been relocated to another gallery.</p>
        <Link href="/#monuments" className="mon-notfound-btn">
          ← Back to Monuments
        </Link>
      </div>
    );
    ...
    <>
      ...
      <div className="mon-page-container">
        ...
        <div className="mon-page" style={{ maxWidth: 1240, margin: '0 auto', padding: '32px 24px 100px', position: 'relative', zIndex: 1 }}>
          ...
          {/* Back link */}
          <Link href="/#monuments" className="mon-back-btn">
          ...
          <div className="mon-layout">
                ...
                {monument.address && (
                  <div className="mon-card reveal-on-scroll delay-200" style={{ marginBottom: '24px' }}>
                    <div className="mon-addr-box">
                      ...
                      <p className="mon-addr-text">{monument.address}</p>
                    </div>
                  </div>
                )}
            ...
            <main className="mon-main">
              ...
              <section className="mon-card reveal-on-scroll">
                ...
                <p className="mon-description">{monument.extract}</p>
              </section>
