...
export default function Hero() {
  ...
  const socialLinks = [
    ...
    {
      href: "https://www.facebook.com/share/1L3XeyDv34/",
      label: "Facebook",
    ...
    {
      href: "https://chat.whatsapp.com/HwCmkqMoVKVFRKxSCanu2N",
      label: "WhatsApp",
      hoverClass: "hover:text-[#25D366] hover:border-[#25D366] hover:bg-[#25D366]/5",
      svg: (
...
<div className="flex flex-col gap-7 items-center mt-6 space-y-6 max-w-[640px] px-4">
  ...
  >
    ...
    <Compass
      size={18}
      strokeWidth={2.5}
      className="relative text-white/90 group-hover:rotate-12 transition-transform duration-500"
    />
    ...
    <span className="relative flex items-center justify-center w-5 h-5">
      <span className="absolute inset-0 rounded-full border border-white/60 group-hover:border-white transition-all duration-300" />
  ...
  <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 pt-2 text-[10px] sm:text-xs font-semibold tracking-[0.2em] uppercase text-[#6B6B67]">
    ...
    <span className="flex items-center gap-1.5">
      ...
      Culinary Soul
        ...
        <div className="fixed bottom-0 left-0 right-0 w-full h-16 z-50 bg-white/95 backdrop-blur-md border-t border-[#EAEAE6] shadow-[0_-4px_24px_rgba(0,0,0,0.03)] flex items-center justify-center px-4 md:hidden">
