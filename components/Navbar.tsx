  ...
  return (
    <>
      ...
      >
       ...
       <div
  className={`fixed top-0 right-0 bottom-0 h-full w-[280px] sm:w-[320px] bg-white/95 backdrop-blur-xl border-l border-gray-100 shadow-[0_0_40px_rgba(0,0,0,0.05)] md:hidden z-50 transform transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] flex flex-col ${
